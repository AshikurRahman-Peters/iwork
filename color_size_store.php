...
if ($cartItems[0]['type']  == 'update') {
    ...
    // Assuming $cartItems contains the data from your form
        ...
        try {
            ...
            `color`,`size`,`qty`,`Customer`,`StyleDescription`,`WO_docnumber`)
            ...
            '$size','$qty','$Customer', '$StyleDescription','$WO_docnumber')";
        ...
        try {
            ...
            $sql = "UPDATE ework_sales_order SET ColorSizeAssortment = 'Yes' WHERE docnumber = '$docnumbers';";
    ...
    try {
        ...
        $sql = "UPDATE ework_order_wise_color_size_qty SET color = '$color',size = '$size',qty = '$quantity' WHERE idlines = '$idlines';";
