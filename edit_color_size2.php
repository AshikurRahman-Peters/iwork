...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                                        ...
                                        <div id="fieldset_lineinformation">
                                            <table class="table table-bordered">
                                                ...
                                                <?php
                                                        ...
                                                        $sql = "SELECT * FROM `ework_order_wise_color_size_qty` where WO_docnumber = '$docnumber'";
                                                        $result = $conn->query($sql);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="color_size_quntity"
                                                                ...
                                                                class="form-control"
                                                                value="<?php echo $value['quantity']?>" required>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-primary"
        ...
        function addToCart() {
            ...
            // var docnumberValue = document.getElementById("WO_docnumber").getAttribute("value");
