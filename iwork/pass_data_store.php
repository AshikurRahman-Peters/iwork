            ...
            if ($conn->query($sql) === TRUE) {
                ...
                if ($data !== null) {
                    ...
                    foreach ($data as $item) {
                        ...
                        $date = date('Y-m-d H:i:s');
                        $sql_defect = "INSERT INTO `ework_defect` (`ID`, `OperationID`, `StepNumber`, `Sewing_Process`, `PartName`, `DefectReason`, `No_of_Defect`, `ReMarks`, `Entry_dateime`, `Delete_datetime`, `Update_datetime`, `Status`) 
