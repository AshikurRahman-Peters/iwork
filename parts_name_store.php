...
if ($cartItems[0]['type']  == 'add'){
    ...
    try {
        ...
        $sql = "INSERT INTO `ework_partname` (`WorkOrder`,`docdate`,`Style`,`linenumber`,`docstatus`,`entrypersonbadge`,`entrypersonname`,`doccreationtime`,`docnumber`,`username`,`lineentrytime`,
        `Customer`,`WO_docnumber`,`PartName`)
         VALUES ('$WorkOrder','$docdate','$Style','$linenumber','$docstatus','$entrypersonbadge','$entrypersonname','$doccreationtime','$docnumber','$username','$lineentrytime','$Customer','$WO_docnumber','$PartName')";
    ...
    try {
      ...
      echo "0 results";
        ...
        $sql = "UPDATE ework_sales_order SET GarmentParts = 'Yes' WHERE docnumber = '$docnumbers';";
