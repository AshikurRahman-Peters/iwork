...
<body class="hold-transition sidebar-mini">
                                ...
                                <div id="formLines">
                                    <div id="fieldset_lineinformation">
                                        <table id="myDataTable" class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                       $sql = "SELECT * FROM `eworker_assignment`";
                                    ...
                                    if($value['WorkerActive'] == '1'){
                                       $value['WorkerActive'] = 'Yes';
                                    }else{
                                       $value['WorkerActive'] = 'No';
                                    }
                                    ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $value['Description_StepName'];?></td>
                                                    <td><?php echo $value['Process'];?></td>
                                                    <td><?php echo $value['cardnumber'];?></td>
                                                    <td><?php echo $value['name'];?></td>
                                                    <td><?php echo $value['position'];?></td>
                                                    <td><?php echo $value['WorkerActive'];?></td>

                                                    <td style="padding: 2px;width: 10%;color: white;">
                                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                                            onclick="editWorkerAssignment('<?php echo $value['docnumber']; ?>')">Edit</button>
                                                    </td>
                                                </tr>
                                                <?php }?>
    ...
    function viewWorkerAssignment(docnumber) {
        window.location.href = 'view_worker_assignment.php?id=' + encodeURIComponent(docnumber);
    }

    function editWorkerAssignment(docnumber) {
        window.location.href = 'edit_worker_assignment.php?id=' + encodeURIComponent(docnumber);
    }
    </script>
</body>
